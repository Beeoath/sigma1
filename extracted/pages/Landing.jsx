...
import { ArrowRight, Lock, PlayCircle, Sparkles } from "lucide-react";
      ...
      >
        <div className="mx-auto flex max-w-7xl items-center gap-4 px-5 py-5 sm:px-8">
          <div className="flex items-center gap-3">
            <span className="grid h-10 w-10 place-items-center rounded-xl bg-sigma-cyan font-display text-xl font-black text-sigma-void">
              Σ
            </span>
            <span className="leading-none">
              <span className="block font-display text-[0.58rem] font-bold tracking-[0.34em] text-sigma-cyan">
                MATEMATIKA
              </span>
              <span className="block font-display text-lg font-black text-white">SIGMA</span>
            </span>
          </div>
          <span className="mono ml-4 hidden text-[0.66rem] uppercase tracking-[0.22em] text-slate-400 lg:block">
            MA Darunnajah 9 × Universitas Pamulang
          </span>
          <Link to="/masuk" className="btn-sigma ml-auto !px-6 !py-3" data-testid="header-login-button">
            Masuk
          </Link>
        </div>
      </header>
      ...
      <section ref={heroRef} className="relative z-10 min-h-[102vh] overflow-hidden">
        ...
        >
          <MaskedLine delay={0.15}>
            <span className="poster-sub block text-[0.8rem] tracking-[0.5em] sm:text-base">
              MATEMATIKA
            </span>
          </MaskedLine>

          <MaskedLine delay={0.28}>
            <h1 className="poster-title mt-2 text-[22vw] leading-[0.78] sm:text-[17vw] lg:text-[13rem]">
              SIGMA
            </h1>
          </MaskedLine>
          ...
          <div className="mt-3 flex flex-wrap items-end gap-x-6 gap-y-2">
            <MaskedLine delay={0.42}>
              <span className="poster-sub text-3xl sm:text-5xl">KELAS 11</span>
            </MaskedLine>
            <MaskedLine delay={0.54}>
              <span className="font-display text-xl font-extrabold tracking-tight text-white sm:text-3xl">
                MA DARUNNAJAH 9
              </span>
            </MaskedLine>
          </div>
          ...
          <motion.p
            ...
            className="mt-7 max-w-xl text-base text-slate-300 sm:text-lg"
          >
            <span className="mono text-sigma-cyan">Sistem Interaktif Gerbang Modul Matematika Atraktif.</span>{" "}
          ...
          >
            <Link to="/masuk" className="btn-sigma text-sm" data-testid="hero-start-journey-button">
              Start Your Journey <ArrowRight size={17} />
            </Link>
            <a href="#kota" className="btn-ghost" data-testid="hero-explore-button">
              <PlayCircle size={17} /> Lihat SIGMA City
            </a>
          </motion.div>
